...
interface LazyRestaurantListProps {
...
export default function LazyRestaurantList({
  restaurants,
  onRestaurantSelect,
  showDistance = false,
  distances = {},
      ...
      {/* Restaurant Cards */}
        ...
        {visibleRestaurants.map((restaurant) => (
          <RestaurantCard
            ...
            distance={distances[restaurant.id]}
            isOnMapPage={isOnMapPage}
          />
        ))}
      </div>
        ...
        >
          {isLoading ? (
            <div className="flex items-center space-x-2">
              ...
              <span className="text-gray-600 text-sm">Loading more restaurants...</span>
            </div>
          ) : (
